...
use backend\assets\AdminDesignAsset;
...
AdminDesignAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<?php $this->beginBody() ?>
  ...
  <div id="main">
      ...
      <ul class="nav navbar-nav navbar-right">
                    ...
                    <div class="tab-content br-n pn">
                      ...
                      <div id="nav-tab2" class="tab-pane chat-widget" role="tabpanel">
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/3.jpg">
                            </a>
                          </div>
                          <div class="media-body">
                        ...
                        <div class="media">
                          ...
                          <div class="media-right">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/1.jpg">
                            </a>
                          </div>
                        </div>
                        <div class="media">
                          <div class="media-left">
                            <a href="#">
                              <img class="media-object" alt="64x64" src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/2.jpg">
                            </a>
                          </div>
                          <div class="media-body">
                            <span class="media-status online"></span>
                      ...
                      <div id="nav-tab3" class="tab-pane scroller-nm" role="tabpanel">
                        <ul class="media-list" role="menu">
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/5.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/2.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/3.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
                          ...
                          <li class="media">
                            <a class="media-left" href="#"> <img src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/4.jpg" class="mw40" alt="avatar"> </a>
                            <div class="media-body">
                              <h5 class="media-heading mv5">Article
                                <small class="text-muted">- 08/16/22</small>
                              </h5> Last Updated 36 days ago by
        ...
        <li class="dropdown menu-merge">
          <a href="#" class="dropdown-toggle fw600 p15" data-toggle="dropdown">
            <img src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/1.jpg" alt="avatar" class="mw30 br64">
            <span class="hidden-xs pl15"> <?= Yii::$app->user->identity->first_name.' '.Yii::$app->user->identity->last_name ?> </span>
          ...
          <div class="sidebar-widget author-widget">
            <div class="media">
              <a class="media-left" href="#">
                <img src="<?= Yii::getAlias('@web') ?>/theme_smooth/assets/img/avatars/3.jpg" class="img-responsive">
              </a>
              <div class="media-body">
                <div class="media-links">
                   <a href="#" class="sidebar-menu-toggle">User Menu -</a> <a href="#" onClick="$('form#formLogout').submit()">Logout</a>
                </div>
                <div class="media-author"><?= Yii::$app->user->identity->first_name.' '.Yii::$app->user->identity->last_name ?></div>
              </div>
            </div>
          </div>
    ...
    <!-- End: Right Sidebar -->
    <?= Html::beginForm(['/site/logout'], 'post',['id'=>'formLogout']) ?>
    <?= Html::endForm() ?>
    <?= $content ?>
...
<!-- Begin: Page Footer -->
<footer id="content-footer" class="affix footer">
    <div class="row">
      <div class="col-md-6">
        <span class="footer-legal">© <?= date('Y') ?> <?= Html::encode(Yii::$app->name) ?></span>
      </div>
      <div class="col-md-6 text-right">
        <span class="footer-meta"><?= Yii::powered() ?></span>
