...
use Yii;
use frontend\models\AuditTrailEntry;
use frontend\models\AuditTrailEntrySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * AuditTrailEntryController implements the CRUD actions for AuditTrailEntry model.
 */
class AuditTrailEntryController extends Controller
{
    /**
     * @inheritdoc
     */
